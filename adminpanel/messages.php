...
if (isset($_SESSION['logged_in'])) {
    ...
    <head>
        ...
        <title>Webcom Admin - Message</title>
    </head>
            ...
            <div class="row">
                ...
                <div class="col p-0">
                    ...
                    <div class="container-fluid">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    $sql = "SELECT * from messages ORDER BY id DESC LIMIT $start_from, $limit";
                        ...
                        <br>
                        <?php
                            $result = $conn->query("SELECT COUNT(id) AS count FROM messages");
        ...
        <script>
            function deleteThing(id, elem) {
                if (confirm('Are you sure ?')) {
                    $.ajax({
                        url: 'php/delete.php?table_name=messages&&id=' + id,
                        type: 'GET',
                        error: function() {
