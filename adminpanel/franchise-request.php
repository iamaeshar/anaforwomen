...
if (isset($_SESSION['logged_in'])) {
    ...
    <head>
        ...
        <title>Webcom Admin - Query</title>
    </head>
            ...
            <div class="row">
                ...
                <div class="col p-0">
                    ...
                    <div class="container-fluid">
                            ...
                            <tbody>
                                <?php
                                   ...
                                   $conn = DB::getConnection();
                                    ...
                                    $sql = "SELECT * from franchise ORDER BY id DESC LIMIT $start_from, $limit";
                        ...
                        <br>
                        <?php
                            $result = $conn->query("SELECT COUNT(id) AS count FROM franchise");
        ...
        <script>
            function deleteThing(id, elem) {
                if (confirm('Are you sure ?')) {
                    $.ajax({
                        url: 'php/delete.php?table_name=franchise&&id=' + id,
                        type: 'GET',
                        error: function() {
